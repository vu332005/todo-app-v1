...
const CheckIcon = ({ onClick, completed }: Props) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox={completed ? "0 0 640 640" : "0 0 512 512"}
      className={`w-7 h-7 rounded-full cursor-pointer transition
        ${completed ? "fill-amber-600 hover:fill-amber-900" : "fill-transparent stroke-slate-900"}
      `}
      strokeWidth={2}
      onClick={onClick}
    >
